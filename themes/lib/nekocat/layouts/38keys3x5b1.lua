  ...
  rows = {
    ...
    row {
      keys = {
        ...
        key(merge(S.e, key { label = { { text = "b \u{F82A}" } }, click = "q", label_symbol = { { text = { "B/A", " ", "\"" }, align = "justify" } }, swipe_up = "\"", popup = { "B", "A", "b", "a" }, key_text_size = main_key_text_size })),
        key(merge(S.r, key { label = { { text = "p \u{F82B}" } }, click = "w", label_symbol = { { text = { "P/E", " ", "+" }, align = "justify" } }, swipe_up = "+", popup = { "P", "E", "p", "e" }, key_text_size = main_key_text_size })),
        key(merge(S.t, key { label = { { text = "m \u{F82C}" } }, click = "e", label_symbol = { { text = { "M/O", " ", "-" }, align = "justify" } }, swipe_up = "-", popup = { "M", "O", "m", "o" }, swipe_down = "KeyboardEditor", key_text_size = main_key_text_size })),
        ...
        key(merge(S.u, key { label = { { text = "ẑ z" } }, click = "t", label_symbol = { { text = { "V/Z", " ", "\\" }, align = "justify" } }, swipe_up = "\\", popup = { "V", "Z", "v", "z" }, key_text_size = main_key_text_size })),
    ...
    row {
      keys = {
        ...
        key(merge(S.j, key { label = { { text = "ĉ c" } }, click = "g", label_symbol = { { text = { "I/C", "𠃋", ";" }, align = "justify", color = { "text", "mauve", "text" } } }, swipe_up = ";", popup = { "I", "C", "i", "c", "·", "§" }, swipe_down = "Z", key_text_size = main_key_text_size })),
    ...
    row {
      keys = {
        ...
        key(merge(S.n, key { label = { { text = "ŝ s" } }, click = "b", label_symbol = { { text = { "U/S", "ic@ideogram-cjk", "~" }, align = "justify" } }, swipe_up = "~", popup = { "ZiTools", "U", "S", "u", "s" }, key_text_size = main_key_text_size })),
