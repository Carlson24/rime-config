  ...
  rows = {
    ...
    row {
      keys = {
        ...
        key(merge(S.u, key { label = { { text = "\u{F82A} z" } }, click = "t", label_symbol = { { text = { "V/Z", " ", "\\" }, align = "justify" } }, swipe_up = "\\", popup = { "V", "Z", "v", "z" }, key_text_size = main_key_text_size })),
    ...
    row {
      keys = {
        ...
        key(merge(S.n, key { label = { { text = "\u{F82C} s" } }, click = "b", label_symbol = { { text = { "U/S", "ic@ideogram-cjk", "~" }, align = "justify" } }, swipe_up = "~", popup = { "ZiTools", "U", "S", "u", "s" }, key_text_size = main_key_text_size })),
